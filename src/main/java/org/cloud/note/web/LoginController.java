...
public class LoginController {
    ...
    @PostMapping("/login")
    public ApiResponse<List<String>> login(@RequestParam(value = "userName") String userName,
        ...
        if (serviceResult.isSuccess()) {
            ...
            //todo 从数据库获取
            res.add("http://localhost:8080/Image/bg.jpg");
    ...
    public ApiResponse<String> file(@RequestParam(name = "file", required = false) MultipartFile file,
                                    User user) {
